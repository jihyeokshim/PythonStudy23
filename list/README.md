...
#### 2차원 리스트는 각 요소에 있는 데이터의 형이 리스트인 경우이다.
...
#### 사용형식: 리스트명 = [[데이터,테이터,...],[데이터,데이터,...],...,[데이터,데이터,...]]

```python
numbers = [10, 20, 30], [40,50,60,70,80,]

print(numbers[0][0])       #number[0]은 리스트 numbers의 0번째 요소,즉[10,20,30]을 의미한다. 따라서[0][0]은 리스트numbers의 0반째 요소의 0번째 요소이다.
print(numbers[0][1])
print(numbers[0][2])
print(numbers[1][0])
print(numbers[1][1])
